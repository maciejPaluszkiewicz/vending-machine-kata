...
class VendingMachine {
    ...
    checkCoinByWeight(coinWeight) {
        const margin = this.coinWeightMargin;
        if (coinWeight > this.coins.dime.weight - margin && coinWeight < this.coins.dime.weight + margin) return "dime";
        if (coinWeight > this.coins.nickel.weight - margin && coinWeight < this.coins.nickel.weight + margin) return "nickel";
        if (coinWeight > this.coins.quarter.weight - margin && coinWeight < this.coins.quarter.weight + margin) return "quarter";
        return "";
    }
